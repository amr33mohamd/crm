                                  ...
                                  <div class="col px-2">
                                      ...
                                      <div class="row mx-0">
                                          ...
                                          <div class="col-lg-6 d-flex justify-content-end align-items-end px-2">
                                              <a href="#" class="btn-admin-default ml-3" data-dismiss="modal"><img src="assets/images/default-close.svg" class="mr-2"/> Cancel</a>
                                              <button  class="btn-admin-primary ml-3"><img src="./assets/images/feather-save.svg" class="mr-2"/> Save</button>
                                          </div>
                                        </form>
                                      </div>
                                  </div>
                            ...
                            <tbody class="height-300">
                              @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td class="disabled">{{$employee->created_at}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
