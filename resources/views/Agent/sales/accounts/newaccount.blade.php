...
<main class="pb-3">
    ...
    <div class="setting-box">
        <div class="container-fluid">
          <form method="post" action="@if($type == 'Add') {{route('NewAccountAction')}} @else /accounts/edit/action/{{$lead->id}} @endif" >
            @csrf
            <div class="row">
                            ...
                            <div class="row px-2">
                                <div class="col-lg-auto col-sm-12 px-2">
                                    <div class="profile-box pl-2">
                                        <div class="profile-img m-auto" ><img style="" id="image" src="/assets/images/user-outline.svg"/></div>
                                        <input type="file" style="display:none" onchange="readURL(this);" name="image" id="image_input" />
